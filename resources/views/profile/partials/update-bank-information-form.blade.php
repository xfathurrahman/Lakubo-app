                        ...
                        <div class="col-span-12 2xl:col-span-4">
                            <div class="mt-3 lg:mt-0">
                                ...
                                <select id="selectBankWd" name="bank_name" class="w-full form-control">
                                    ...
                                    <option value="BRI" {{ Auth::user()->bank_name === 'BRI' ? 'selected' : '' }}>Bank Rakyat Indonesia (BRI)</option>
                                    <option value="BCA" {{ Auth::user()->bank_name === 'BCA' ? 'selected' : '' }}>Bank Central Asia (BCA)</option>
                                    <option value="MANDIRI" {{ Auth::user()->bank_name === 'MANDIRI' ? 'selected' : '' }}>Bank Mandiri</option>
                                    <option value="BNI" {{ Auth::user()->bank_name === 'BNI' ? 'selected' : '' }}>Bank Negara Indonesia (BNI)</option>
                                    <option value="PERMATA" {{ Auth::user()->bank_name === 'PERMATA' ? 'selected' : '' }}>Bank Permata</option>
                                    <option value=" " disabled>E-Wallet</option>
                                    <option value="GOPAY" {{ Auth::user()->bank_name === 'GOPAY' ? 'selected' : '' }}>Gopay</option>
                                    <option value="DANA" {{ Auth::user()->bank_name === 'DANA' ? 'selected' : '' }}>Dana</option>
                                    <option value="SHOPPE-PAY" {{ Auth::user()->bank_name === 'SHOPPE-PAY' ? 'selected' : '' }}>Shoppe Pay</option>
                                </select>
                            </div>
                        </div>
                    </div>
