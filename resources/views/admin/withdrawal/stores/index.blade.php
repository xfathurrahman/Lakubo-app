<x-app-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('store-withdrawal') }}
    @endsection
    ...
    <div class="grid grid-cols-12 gap-2 mt-5">
        ...
        <div class="intro-y col-span-12 sm:overflow-auto 2xl:overflow-visible">
            <table id="order-table" class="table table-report w-full table-fixed -mt-2">
                ...
                <tbody>
                    @include('admin.withdrawal.partials.wd_store_table', ['storeWds' => $storeWds])
                </tbody>
            </table>
        </div>
        <!-- END: Data List -->
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('change', '#changeStatus', function() {
                    ...
                    $.ajax({
                    url: '{{ route('admin.store.transaction.update') }}',
                    type: 'POST',
                    data: {
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#filterStatus').change(function() {
                    ...
                    $.ajax({
                        url: '{{ route('admin.withdrawal.store.index') }}',
