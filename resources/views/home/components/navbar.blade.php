        ...
        @auth()
            <form>
                <div class="flex mx-auto ml-1">
                    ...
                    <div id="dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow" style="position: absolute; transform: translate(30px, 55px);">
                        <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdown-button">
                            <li>
                    ...
                    <div class="relative">
                        <input type="search" id="search-dropdown"
                               ...
                               placeholder="Cari produk UMKM..." required="">
                        <button type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-red-400 rounded-r-lg border border-red-400 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-red-200">
                        ...
                        <div class="flex justify-center items-center cursor-pointer">
                            <button class="w-10 h-10 flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
                                @if(auth()->user()->profile_photo_path)
                                    <img class="mr-1.5 rounded-full" alt="Profile-photo-preview" src="{{ asset('storage/profile-photos/'. auth()->user()->profile_photo_path) }}">
                                @else
                                    <img class="mr-1.5 rounded-full" alt="Profile-photo-preview" src="https://ui-avatars.com/api/?size=100&name={{ Auth::user()->name }}">
                                @endif
