<div class="bg-white p-4 flex items-center flex-wrap">
    <ul class="flex items-center">
        <li class="inline-flex items-center">
            ...
            <span class="mx-4 h-auto text-gray-400 font-medium"> <i class="fa-solid fa-chevron-right text-xs"></i> </span>
        </li>
        @isset($product->productCategories)
            <li class="inline-flex items-center">
                <a href="#" class="text-xs font-medium md:text-sm text-gray-600 hover:text-red-500">
        ...
        @endisset
        <li class="inline-flex items-center">
            <a href="#" class="text-xs md:text-sm text-gray-600 hover:text-red-500 text-blue-500">
                {{ $product -> name }}
            </a>
        </li>
    </ul>
