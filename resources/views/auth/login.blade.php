        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        Selamat datang,
                        <br>
                        Pelanggan UMKM Boyolali !
                    </div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70">Kelola semua pesanan dengan mudah
                        dalam satu tempat!
                    </div>
                </div>
            </div>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="flex justify-center items-center pt-3 sm:pt-0">
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">
                        ...
                        Pelanggan UMKM Boyolali !
                        <br>
                        Kelola semua fitur dengan mudah dalam satu tempat!
                    </div>
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <!-- Password -->
                        <div class="relative intro-y mt-5">
                            <div class="absolute mr-1 right-0 flex items-center" style="margin-top: 1.95rem;">
                                <input class="hidden js-password-toggle" id="toggle" type="checkbox"/>
                                <label
                                    class="bg-gray-300 hover:bg-gray-400 rounded px-2 mt-1 py-1 text-sm text-gray-600 font-mono cursor-pointer js-password-label"
                                    for="toggle">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                         stroke-linejoin="round" icon-name="eye-off" data-lucide="eye-off"
                                         class="lucide lucide-eye-off block mx-auto">
                                        <path
                                            d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"></path>
                            ...
                            <input type="password" name="password"
                                   class="login__input form-control py-3 px-4 block js-password"
                                   placeholder="Masukan kata sandi" id="password" autocomplete="off" required
                                   data-parsley-minlength="8">
                        </div>
                        <!-- Remember Me -->
                        <div class="block mt-4 intro-x">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left float-right">
                            <a href="{{ route('register') }}"
                               class="btn btn-outline-secondary py-3 px-4 w-full xl:mr-3 xl:w-32 mt-3 xl:mt-0 align-top">Mendaftar</a>
                            <button type="submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 align-top">Masuk
                            </button>
                        </div>
                    </form>
