            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                        Selamat datang di Lakubo!
                        <br>
                        Lapak UMKM Boyolali
                    </div>
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70">Tempatnya produk UMKM Boyolali</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    @if(Session::has('error'))
                        <div id="alert-border-2" class="flex mt-4 p-4 mb-4 bg-red-100 border-t-4 border-red-500" role="alert">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="intro-y mt-5">
                            ...
                            <input id="email" name="email" type="email" class="intro-x login__input form-control py-3 px-4 block" placeholder="Lakubo@lakubo.com" required data-parsley-type-message="Email tidak valid">
                        </div>
                        <!-- Password -->
                        <div class="relative intro-y mt-5">
                            <div class="absolute mr-1 right-0 flex items-center" style="margin-top: 1.95rem;">
                                <input class="hidden js-password-toggle" id="toggle" type="checkbox" />
                                <label class="bg-gray-300 hover:bg-gray-400 rounded px-2 mt-1 py-1 text-sm text-gray-600 font-mono cursor-pointer js-password-label" for="toggle">
                                    <i data-lucide="eye-off"></i>
                                </label>
                            </div>
                            <label for="password" class="form-label">Kata Sandi</label>
                            <input type="password" name="password" class="login__input form-control py-3 px-4 block js-password" placeholder="Masukan kata sandi" id="password" autocomplete="off" required data-parsley-minlength="8">
                        </div>
                        <!-- Remember Me -->
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left float-right">
                            <a href="http://127.0.0.1:8000/register" class="btn btn-outline-secondary py-3 px-4 w-full xl:mr-3 xl:w-32 mt-3 xl:mt-0 align-top">Mendaftar</a>
                            <button type="submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 align-top">Masuk</button>
                        </div>
                    </form>
