            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto bg-white shadow-lg p-10 sm:px-20 rounded-md shadow-md w-full">
                    ...
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left float-right inline-flex">
                            <a href="{{ route('register') }}" class="btn btn-outline-secondary py-3 px-4 w-full mr-3 xl:w-32 mt-3 xl:mt-0 align-top">Mendaftar</a>
                            <button type="submit" class="btn btn-primary py-3 px-4 w-full mr-3 xl:w-32 mt-3 xl:mt-0 align-top">Masuk</button>
                        </div>
                    </form>
