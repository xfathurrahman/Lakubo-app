<x-app-layout>
    ...
    <style>
        .transaction-filter .select2.select2-container {
            width: 200px !important;
        }
        .transaction-filter .select2.select2-container .select2-selection {
        ...
        .transaction-filter .select2.select2-container .select2-selection .select2-selection__arrow {
            background: #f8f8f8;
        ...
        .transaction-filter .select2.select2-container .select2-selection .select2-selection__rendered {
            color: #333;
            line-height: 38px;
            padding-right: 33px;
        }
        .transaction-filter .select2-container--default .select2-selection--single .select2-selection__arrow {
            height: 26px;
            position: absolute;
            top: -1px;
            right: -1px;
        ...
        .transaction-filter .select2-container .select2-dropdown .select2-results ul {
            background: #fff;
    ...
    <!-- BEGIN: Content -->
    <div class="grid grid-cols-12 gap-6 mt-5 transaction-filter">
