        ...
        <div class="intro-y mt-0">
            <form method="post" action="{{ route('customer.withdraw.store') }}" class="space-y-3">
                ...
                <div class="flex items-center p-2 border-b border-slate-200/60 dark:border-darkmode-400">
                    <span class="text-2xl font-medium text-primary mx-auto">Penarikan dana</span>
                </div>
                            ...
                            <div class="bg-gray-200 mt-8 p-2 rounded">
                                <div class="flex justify-between">
                                    <div class="flex justify-between">
                                        ...
                                        <span class="ml-2">: {{ Auth::user()->bank_account_number }}</span>
                                    </div>
                                </div>
                                <div class="inline-flex">
                                    <span class="w-20">Atas nama</span>
                                    <span class="ml-2">: {{ Auth::user()->bank_account_name }}</span>
                                </div>
                                <div class="inline-flex w-full">
                                    <span class="w-20">Nama Bank</span>
                                    <span class="ml-2">: {{ Auth::user()->bank_name }}</span>
                                    <a class="ml-auto mr-0 text-blue-400" href="{{ route('profile.edit') }}">Ubah</a>
                                </div>
                            </div>
                            <div class="mt-6">
                        ...
                        @else
                            <div class="bg-gray-200 mt-8 p-2 rounded">
                                <div class="flex justify-between">
                                    ...
                                    <a class="text-blue-400" href="{{ route('profile.edit') }}">Tambah</a>
                                </div>
                            </div>
                        @endif
                    </div>
