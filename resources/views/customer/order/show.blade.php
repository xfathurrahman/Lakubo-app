                ...
                <div class="intro-y grid grid-cols-11 gap-5 mt-5">
                    <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
                        <div class="box p-5 rounded-md">
                            ...
                            <div class="flex items-center"> <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> Invoice: {{ $orders->invoice }} </div>
                            ...
                            <div class="flex items-center mt-3"> <i data-lucide="clock" class="w-4 h-4 text-slate-500 mr-2"></i> Status Transaksi:<span class="bg-success/20 text-danger rounded px-2 ml-1">{{ $orders -> status }}</span></div>
                            <div class="flex items-center mt-3">
                                <i data-lucide="credit-card" class="w-4 h-4 text-slate-500 mr-2"></i> Total Harga ({{ $orders->orderItems->count() }} Item):
                                <div class="ml-auto">@currency($orders->total_price)</div>
                            </div>
                            <div class="flex items-center mt-3">
                            ...
                            <div class="flex items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium">
                                ...
                                <div class="ml-auto">@currency($orders->total_price+$orders->shipping)</div>
                            </div>
                            <div class="flex items-center border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium">
                        ...
                        <div class="box p-5 rounded-md mt-5">
                            ...
                            <div class="flex items-center mt-3 capitalize_address">
                                ...
                                {{ $orders->orderAddresses->detail_address }},
                                {{ $orders->orderAddresses->village->name }},
                                {{ $orders->orderAddresses->district->name }},
                                {{ $orders->orderAddresses->regency->name }},
                                {{ $orders->orderAddresses->province->name }}.
                            </div>
                        </div>
                        <div class="box p-5 rounded-md mt-5">
                            <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
