<x-app-layout>
                        ...
                        @isset($order->bank)
                            <div class="mt-2 rounded-lg">
                                ...
                                <div class="relative bg-gray-200 p-1 rounded mt-1">
                                    <div class="underline text-center decoration-solid decoration-red-400">
                                        <p class="inline-flex" id="va_number">{{ $order->va_number }}</p>
                            ...
                            <div class="mt-2 rounded-lg">
                                ...
                                <div class="w-full items-center text-center">
                                    ...
                                    <div class="relative inline-flex">
                                        <p class="mt-1" id="payment_code">{{ $order->payment_code }}</p>
                                        <button onclick="copyToClipboard('#payment_code')" class="text-gray-500 hover:text-gray-600 focus:outline-none ml-2">
                                            <i class="fas fa-copy text-gray-400"></i>
                                        </button>
                                    </div>
                                </div>
    ...
    @section('script')
        <script src="{{ env('MIDTRANS_IS_PRODUCTION') === 'true' ? 'https://app.midtrans.com/snap/snap.js' : 'https://app.sandbox.midtrans.com/snap/snap.js'}}" data-client-key="config('midtrans.client_key')"></script>
        <script>
